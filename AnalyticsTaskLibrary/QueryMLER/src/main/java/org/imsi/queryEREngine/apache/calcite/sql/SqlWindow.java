...
public class SqlWindow extends SqlCall {
	 ...
	 *
	 * @see org.imsi.queryEREngine.apache.calcite.rel.core.Window.Group#isAlwaysNonEmpty()
	 * @see SqlOperatorBinding#getGroupCount()
	 * @see org.imsi.queryEREngine.apache.calcite.sql.validate.SqlValidatorImpl#resolveWindow(SqlNode, org.imsi.queryEREngine.apache.calcite.sql.validate.SqlValidatorScope, boolean)
	 */
