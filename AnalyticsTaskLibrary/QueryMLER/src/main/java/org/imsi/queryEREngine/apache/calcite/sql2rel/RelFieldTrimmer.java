...
import org.imsi.queryEREngine.apache.calcite.util.ReflectiveVisitor;
import org.imsi.queryEREngine.apache.calcite.util.Util;
import org.imsi.queryEREngine.apache.calcite.util.mapping.IntPair;
...
public class RelFieldTrimmer implements ReflectiveVisitor {
	...
	/**
	 * Visit method, per {@link org.imsi.queryEREngine.apache.calcite.util.ReflectiveVisitor}.
	 *
	...
	/**
	 * Variant of {@link #trimFields(RelNode, ImmutableBitSet, Set)} for
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Sort}.
	 */
	public TrimResult trimFields(
			Sort sort,
			ImmutableBitSet fieldsUsed,
	...
	/**
	 * Variant of {@link #trimFields(RelNode, ImmutableBitSet, Set)} for
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.SetOp} (including UNION and UNION ALL).
	 */
	public TrimResult trimFields(
			SetOp setOp,
			ImmutableBitSet fieldsUsed,
	...
	/**
	 * Variant of {@link #trimFields(RelNode, ImmutableBitSet, Set)} for
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalAggregate}.
	 */
	public TrimResult trimFields(
			Aggregate aggregate,
			ImmutableBitSet fieldsUsed,
	...
	/**
	 * Variant of {@link #trimFields(RelNode, ImmutableBitSet, Set)} for
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalValues}.
	 */
	public TrimResult trimFields(
	 ...
	 *
	 * <p>The mapping is a
	 * {@link org.imsi.queryEREngine.apache.calcite.util.mapping.Mappings.SourceMapping}, which means
