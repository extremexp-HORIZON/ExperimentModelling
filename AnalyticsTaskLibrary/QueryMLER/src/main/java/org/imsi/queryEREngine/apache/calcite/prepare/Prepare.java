...
import org.imsi.queryEREngine.apache.calcite.jdbc.CalciteSchema.LatticeEntry;
import org.imsi.queryEREngine.apache.calcite.plan.Convention;
import org.imsi.queryEREngine.apache.calcite.plan.RelOptLattice;
...
import org.imsi.queryEREngine.apache.calcite.schema.ExtensibleTable;
...
import org.imsi.queryEREngine.apache.calcite.sql.validate.SqlValidatorCatalogReader;
import org.imsi.queryEREngine.apache.calcite.sql.validate.SqlValidatorTable;
import org.imsi.queryEREngine.apache.calcite.sql2rel.InitializerContext;
...
import org.imsi.queryEREngine.apache.calcite.tools.Programs;
import org.imsi.queryEREngine.apache.calcite.util.Holder;
import org.imsi.queryEREngine.apache.calcite.util.TryThreadLocal;
import org.imsi.queryEREngine.apache.calcite.util.trace.CalciteTimingTracer;
...
public abstract class Prepare {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.RelNode} with a 'slimmed down' relational
	...
	public static class Materialization {
		 ...
		 * {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalTableScan}. */
		RelNode tableRel;
