 ...
 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Join} and creates
 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Filter}s if those predicates can be pushed
 * to its inputs.
 *
 * <p>Uses {@link org.imsi.queryEREngine.apache.calcite.rel.metadata.RelMdPredicates} to infer
 * the predicates,
 * returns them in a {@link org.imsi.queryEREngine.apache.calcite.plan.RelOptPredicateList}
