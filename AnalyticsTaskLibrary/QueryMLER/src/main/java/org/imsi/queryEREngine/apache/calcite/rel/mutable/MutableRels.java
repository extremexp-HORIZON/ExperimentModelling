...
public abstract class MutableRels {
	...
	/** Based on
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.rules.ProjectRemoveRule#strip}. */
	public static MutableRel strip(MutableProject project) {
		return isTrivial(project) ? project.getInput() : project;
	}

	/** Based on
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.rules.ProjectRemoveRule#isTrivial(org.imsi.queryEREngine.apache.calcite.rel.core.Project)}. */
	...
	/** Equivalent to
	 * {@link RelOptUtil#createProject(org.imsi.queryEREngine.apache.calcite.rel.RelNode, java.util.List)}
	 * for {@link MutableRel}. */
	...
	/** Equivalence to {@link org.imsi.queryEREngine.apache.calcite.plan.RelOptUtil#createCastRel}
	 * for {@link MutableRel}. */
