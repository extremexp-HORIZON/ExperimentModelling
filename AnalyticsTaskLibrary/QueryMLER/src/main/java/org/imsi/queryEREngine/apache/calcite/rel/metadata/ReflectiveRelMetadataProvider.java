...
implements RelMetadataProvider, ReflectiveVisitor {
	 ...
	 * that extend {@link org.imsi.queryEREngine.apache.calcite.rel.core.Union}
	 * or {@link org.imsi.queryEREngine.apache.calcite.rel.core.Filter}.</p>
	 */
	...
	private static RelMetadataProvider reflectiveSource(
		...
		// See map.put in org.imsi.queryEREngine.apache.calcite.rel.metadata.ReflectiveRelMetadataProvider.apply(
		// java.lang.Class<? extends org.imsi.queryEREngine.apache.calcite.rel.RelNode>)
