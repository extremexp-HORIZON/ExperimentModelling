 ...
 * {@link org.imsi.queryEREngine.apache.calcite.rel.RelCollation} and an Exchange produces output
 * with a particular {@link org.imsi.queryEREngine.apache.calcite.rel.RelDistribution}, the output
...
public abstract class SortExchange extends Exchange {
	...
	/**
	 * Returns the array of {@link org.imsi.queryEREngine.apache.calcite.rel.RelFieldCollation}s
	 * asked for by the sort specification, from most significant to least
	 * significant.
	 *
	 * <p>See also
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.metadata.RelMetadataQuery#collations(RelNode)},
