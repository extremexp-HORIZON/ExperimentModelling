...
import org.imsi.queryEREngine.apache.calcite.util.CancelFlag;
...
public interface RelOptPlanner {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.convert.ConverterRule} and pass the
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalTableScan} representing a
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.plan.RelOptCost}s.
	 */
	...
	/**
	 * Thrown by {@link org.imsi.queryEREngine.apache.calcite.plan.RelOptPlanner#findBestExp()}.
	 */
