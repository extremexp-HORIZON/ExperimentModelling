...
import org.imsi.queryEREngine.apache.calcite.plan.RexImplicationChecker;
import org.imsi.queryEREngine.apache.calcite.plan.Strong;
 ...
 * {@link org.imsi.queryEREngine.apache.calcite.rel.rules.JoinPushTransitivePredicatesRule} to
...
implements MetadataHandler<BuiltInMetadata.Predicates> {
	 ...
	 *
	 * @see org.imsi.queryEREngine.apache.calcite.rel.metadata.RelMetadataQuery#getPulledUpPredicates(RelNode)
	 */
	...
	/**
	 * Infers predicates for a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Join} (including
	 * {@code SemiJoin}).
	 */
	 ...
	 * <p>Contract is:<ul>
	 *
	 * <li>initialize with a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Join} and
