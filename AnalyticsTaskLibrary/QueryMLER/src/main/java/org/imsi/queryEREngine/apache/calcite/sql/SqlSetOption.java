...
public class SqlSetOption extends SqlAlter {
	...
	/** Name of the option as an {@link org.imsi.queryEREngine.apache.calcite.sql.SqlIdentifier}
	 * with one or more parts.*/
	SqlIdentifier name;

	/** Value of the option. May be a {@link org.imsi.queryEREngine.apache.calcite.sql.SqlLiteral} or
	 * a {@link org.imsi.queryEREngine.apache.calcite.sql.SqlIdentifier} with one
