...
import org.imsi.queryEREngine.apache.calcite.rex.RexUnknownAs;
...
public abstract class ReduceExpressionsRule extends RelOptRule {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalFilter}.
	 */
	...
	/**
	 * Singleton rule that reduces constants inside a
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalWindow}.
	 */
	...
	/**
	 * Rule that reduces constants inside a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Filter}.
	 * If the condition is a constant, the filter is removed (if TRUE) or replaced with
	 * an empty {@link org.imsi.queryEREngine.apache.calcite.rel.core.Values} (if FALSE or NULL).
	 */
	public static class FilterReduceExpressionsRule extends ReduceExpressionsRule {
		 ...
		 * to an empty
		 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Values}.
		 *
	...
	/**
	 * Rule that reduces constants inside a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Project}.
	 */
	...
	/**
	 * Rule that reduces constants inside a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Join}.
	 */
	...
	/**
	 * Rule that reduces constants inside a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Calc}.
	 */
	...
	/**
	 * Rule that reduces constants inside a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Window}.
	 */
