...
public class JsonLattice {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.materialize.LatticeStatisticProvider} interface.
	 *
	 * <p>Or, you can use a class name plus a static field, for example
	 * "org.imsi.queryEREngine.apache.calcite.materialize.Lattices#CACHING_SQL_STATISTIC_PROVIDER".
	 *
