...
public interface Planner extends AutoCloseable {
	 ...
	 * @throws org.imsi.queryEREngine.apache.calcite.sql.parser.SqlParseException on parse error
	 */
	 ...
	 *
	 * <p>You must call {@link #validate(org.imsi.queryEREngine.apache.calcite.sql.SqlNode)} first.
	 *
	 * @param sql The root node of the SQL parse tree.
	 * @return The root node of the newly generated RelNode tree.
	 * @throws org.imsi.queryEREngine.apache.calcite.tools.RelConversionException if the node
	 ...
	 * @throws org.imsi.queryEREngine.apache.calcite.tools.RelConversionException on conversion
	 *     error
	 */
