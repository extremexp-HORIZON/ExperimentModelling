 ...
 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Aggregate}s beneath a
 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Union} and pulls them up, so
 * that a single
 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Aggregate} removes duplicates.
 *
 * <p>This rule only handles cases where the
 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Union}s
