...
import org.imsi.queryEREngine.apache.calcite.rel.rules.AggregateFilterTransposeRule;
...
import org.imsi.queryEREngine.apache.calcite.rel.rules.JoinProjectTransposeRule;
...
public class RelOptMaterialization {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.schema.impl.StarTable}.
	 *
	 * <p>The relational expression is already in leaf-join-form, per
	 * {@link #toLeafJoinForm(org.imsi.queryEREngine.apache.calcite.rel.RelNode)}.
	 *
	...
	public static RelNode tryUseStar(RelNode rel,
		...
		RelNode rel2 = rel.accept(
				new RelShuttleImpl() {
					...
					/** Throws a {@link org.imsi.queryEREngine.apache.calcite.util.Util.FoundOne} containing
					 * a {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalTableScan} on
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalJoin}s are
