...
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableAggregate;
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableFilter;
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableHashJoin;
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableProject;
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableTableScan;
import org.imsi.queryEREngine.apache.calcite.config.CalciteSystemProperty;
import org.imsi.queryEREngine.apache.calcite.interpreter.JaninoRexCompiler;
...
import org.imsi.queryEREngine.apache.calcite.rel.stream.LogicalChi;
		...
		for (Ord<Method> method : Ord.zip(def.methods)) {
			...
			.append(
					(method.e.getParameterTypes().length < 4
							? org.imsi.queryEREngine.apache.calcite.runtime.FlatLists.class
