...
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableCorrelate;
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableHashJoin;
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableMergeJoin;
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableNestedLoopJoin;
...
import org.imsi.queryEREngine.apache.calcite.rel.core.SortExchange;
 ...
 * {@link org.imsi.queryEREngine.apache.calcite.rel.metadata.RelMetadataQuery#collations}
...
implements MetadataHandler<BuiltInMetadata.Collation> {
	 ...
	 *
	 * <p>{@link org.imsi.queryEREngine.apache.calcite.rel.core.Union},
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Intersect},
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Minus},
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Join},
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Correlate}
	 ...
	 *
	 * @see org.imsi.queryEREngine.apache.calcite.rel.metadata.RelMetadataQuery#collations(RelNode)
	 */
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.TableScan}'s collation. */
	public static List<RelCollation> table(RelOptTable table) {
		return table.getCollationList();
	}

	/** Helper method to determine a
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Snapshot}'s collation. */
	public static List<RelCollation> snapshot(RelMetadataQuery mq, RelNode input) {
		return mq.collations(input);
	}

	/** Helper method to determine a
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Sort}'s collation. */
	public static List<RelCollation> sort(RelCollation collation) {
		return ImmutableList.of(collation);
	}

	/** Helper method to determine a
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Filter}'s collation. */
	...
	/** Helper method to determine a
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Calc}'s collation. */
	...
	/** Helper method to determine a
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Window}'s collation.
	 *
	...
	/** Helper method to determine a
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Match}'s collation. */
	...
	/** Helper method to determine a
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Values}'s collation.
	 *
