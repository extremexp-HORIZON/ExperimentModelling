...
import org.imsi.queryEREngine.apache.calcite.adapter.enumerable.RexToLixTranslator.InputGetter;
...
public class RexExecutorImpl implements RexExecutor {
	...
	/**
	 * Implementation of
	 * {@link org.imsi.queryEREngine.apache.calcite.adapter.enumerable.RexToLixTranslator.InputGetter}
	 * that reads the values of input fields by calling
	 * <code>{@link org.imsi.queryEREngine.apache.calcite.DataContext#get}("inputRecord")</code>.
	 */
