 ...
 * {@link org.imsi.queryEREngine.apache.calcite.rex.RexOver} objects.
 *
 * <p>Created by {@link org.imsi.queryEREngine.apache.calcite.rel.rules.ProjectToWindowRule}.
 */
public abstract class Window extends SingleRel {
	...
	public static class Group {
		 ...
		 * {@link org.imsi.queryEREngine.apache.calcite.sql.SqlAggFunction}.
		 */
		 ...
		 * @see org.imsi.queryEREngine.apache.calcite.sql.SqlWindow#isAlwaysNonEmpty()
		 * @see org.imsi.queryEREngine.apache.calcite.sql.SqlOperatorBinding#getGroupCount()
		 * @see org.imsi.queryEREngine.apache.calcite.sql.validate.SqlValidatorImpl#resolveWindow(org.imsi.queryEREngine.apache.calcite.sql.SqlNode, org.imsi.queryEREngine.apache.calcite.sql.validate.SqlValidatorScope, boolean)
		 */
	 ...
	 *
	 * <p>It's a bastard son of a {@link org.imsi.queryEREngine.apache.calcite.rex.RexCall}; similar
	 * enough that it gets visited by a {@link org.imsi.queryEREngine.apache.calcite.rex.RexVisitor},
