...
import static org.imsi.queryEREngine.apache.calcite.schema.impl.MaterializedViewTable.MATERIALIZATION_CONNECTION;
...
public class CloneSchema extends AbstractSchema {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.adapter.clone.CloneSchema}.
	 ...
	 *       name: 'FOODMART_CLONE',
	 *       type: 'custom',
	 *       factory: 'org.imsi.queryEREngine.apache.calcite.adapter.clone.CloneSchema$Factory',
	 *       operand: {
