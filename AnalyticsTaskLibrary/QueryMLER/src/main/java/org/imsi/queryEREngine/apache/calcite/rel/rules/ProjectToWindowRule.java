 ...
 * If the {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalCalc} does not contain
 * any windowed agg functions, does nothing.
 *
 * <p>There is also a variant that matches
 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Calc} rather than {@code Project}.
 */
public abstract class ProjectToWindowRule extends RelOptRule {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Calc} that contains
	 * windowed aggregates and converts it into a mixture of
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalWindow} and {@code Calc}.
	 */
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Project} and that produces, in turn,
	 * a mixture of {@code LogicalProject}
	 * and {@link org.imsi.queryEREngine.apache.calcite.rel.logical.LogicalWindow}.
	 */
