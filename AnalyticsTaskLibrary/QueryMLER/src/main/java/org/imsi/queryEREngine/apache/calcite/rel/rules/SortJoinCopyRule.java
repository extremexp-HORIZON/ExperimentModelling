...
/**
 * Planner rule that copies a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Sort} past a
 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Join} without its limit and offset. The
 * original {@link org.imsi.queryEREngine.apache.calcite.rel.core.Sort} is preserved but can be
 * potentially removed by {@link org.imsi.queryEREngine.apache.calcite.rel.rules.SortRemoveRule} if
 * redundant.
 *
 * <p>Some examples where {@link org.imsi.queryEREngine.apache.calcite.rel.rules.SortJoinCopyRule}
 * can be useful: allowing a {@link org.imsi.queryEREngine.apache.calcite.rel.core.Sort} to be
