 ...
 */
package org.imsi.queryEREngine.apache.calcite.util.trace;

import java.io.File;

import org.apache.calcite.linq4j.function.Function2;
import org.apache.calcite.linq4j.function.Functions;
import org.imsi.queryEREngine.apache.calcite.plan.RelImplementor;
 ...
 * org.imsi.queryEREngine.apache.calcite class libraries.
 *
 * <h2>Note to developers</h2>
 *
 * <p>Please ensure that every tracer used in org.imsi.queryEREngine.apache.calcite is added to
...
public abstract class CalciteTrace {
	...
	/**
	 * The "org.imsi.queryEREngine.apache.calcite.sql.parser" tracer reports parser events in
	 * {@link org.imsi.queryEREngine.apache.calcite.sql.parser.SqlParser} and other classes at DEBUG.
	 */
	...
	/**
	 * The "org.imsi.queryEREngine.apache.calcite.plan.RelOptPlanner" tracer prints the query
	...
	/**
	 * The "org.imsi.queryEREngine.apache.calcite.prepare.Prepare" tracer prints the generated
	...
	/**
	 * The "org.imsi.queryEREngine.apache.calcite.rel.RelImplementorImpl" tracer reports when
	...
	/**
	 * The tracer "org.imsi.queryEREngine.apache.calcite.sql.timing" traces timing for
	 * various stages of query processing.
	 *
	 * @see CalciteTimingTracer
	 */
	public static Logger getSqlTimingTracer() {
		return LoggerFactory.getLogger("org.imsi.queryEREngine.apache.calcite.sql.timing");
	}

	/**
	 * The "org.imsi.queryEREngine.apache.calcite.sql.parser" tracer reports parse events.
	 */
	public static Logger getParserTracer() {
		return LoggerFactory.getLogger("org.imsi.queryEREngine.apache.calcite.sql.parser");
	}

	/**
	 * The "org.imsi.queryEREngine.apache.calcite.sql2rel" tracer reports parse events.
	 */
	public static Logger getSqlToRelTracer() {
		return LoggerFactory.getLogger("org.imsi.queryEREngine.apache.calcite.sql2rel");
	}
