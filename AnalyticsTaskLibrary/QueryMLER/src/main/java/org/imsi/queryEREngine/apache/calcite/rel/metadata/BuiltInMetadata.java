...
import org.imsi.queryEREngine.apache.calcite.rex.RexTableInputRef;
...
public abstract class BuiltInMetadata {
	...
	public interface UniqueKeys extends Metadata {
		 ...
		 * represented as an {@link org.imsi.queryEREngine.apache.calcite.util.ImmutableBitSet}, where
	...
	public interface ExpressionLineage extends Metadata {
		 ...
		 * in an {@link org.imsi.queryEREngine.apache.calcite.rel.core.Aggregate} operator)
		 */
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.TableScan} for the result predicates.
	 */
	...
	public interface Parallelism extends Metadata {
		 ...
		 * a leaf node such as a {@link org.imsi.queryEREngine.apache.calcite.rel.core.TableScan},
		 * or with a phase-change node such as an
		 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Exchange}. Hadoop's shuffle operator
	...
	public interface Memory extends Metadata {
		 ...
		 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Aggregate} that loads all data into a
