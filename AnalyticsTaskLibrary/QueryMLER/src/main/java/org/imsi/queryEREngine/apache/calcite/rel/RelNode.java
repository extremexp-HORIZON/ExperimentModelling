...
import org.imsi.queryEREngine.apache.calcite.plan.RelOptNode;
import org.imsi.queryEREngine.apache.calcite.plan.RelOptPlanner;
import org.imsi.queryEREngine.apache.calcite.plan.RelOptQuery;
 ...
 * {@link org.imsi.queryEREngine.apache.calcite.sql.SqlNode} and {@link RexNode}.</p>
 *
 ...
 * a {@link org.imsi.queryEREngine.apache.calcite.plan.RelImplementor} to manage the process. Every
 ...
 * RelNode. For example,
 * {@code org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableRel}
 * has operations to manage the conversion to a graph of
 * {@code org.imsi.queryEREngine.apache.calcite.adapter.enumerable.EnumerableConvention}
...
public interface RelNode extends RelOptNode, Cloneable {
	 ...
	 *
	 * @deprecated use #accept(org.imsi.queryEREngine.apache.calcite.rex.RexShuttle)
	 * @return List of this relational expression's child expressions
	 * @see #accept(org.imsi.queryEREngine.apache.calcite.rex.RexShuttle)
	 */
	 ...
	 *
	 * <p>Note: only {@link org.imsi.queryEREngine.apache.calcite.rel.core.Correlate} should set
	 * variables.
	 *
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.util.Glossary#VISITOR_PATTERN visitor pattern} to
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.externalize.RelWriterImpl#input(String, RelNode)}
	 * and
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.externalize.RelWriterImpl#item(String, Object)}
	 ...
	 * org.imsi.queryEREngine.apache.calcite.rel.ArrayRel.ArrayReader</code>, this method returns
	 * "ArrayReader".
	 *
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.plan.RelOptPlanner#addRule} for each rule, and
