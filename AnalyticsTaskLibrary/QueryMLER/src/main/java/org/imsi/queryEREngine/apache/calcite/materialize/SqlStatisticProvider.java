 ...
 *
 * <p>It uses {@link org.imsi.queryEREngine.apache.calcite.plan.RelOptTable} because that contains
 * enough information to generate and execute SQL, while not being tied to a
 * lattice.
 *
 * <p>The main implementation,
 * {@link org.imsi.queryEREngine.apache.calcite.statistic.QuerySqlStatisticProvider}, executes
