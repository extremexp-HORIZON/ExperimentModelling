...
import org.imsi.queryEREngine.apache.calcite.sql.SqlAsOperator;
...
import org.imsi.queryEREngine.apache.calcite.sql.SqlDescriptorOperator;
import org.imsi.queryEREngine.apache.calcite.sql.SqlFilterOperator;
...
import org.imsi.queryEREngine.apache.calcite.sql.SqlGroupedWindowFunction;
import org.imsi.queryEREngine.apache.calcite.sql.SqlInternalOperator;
...
import org.imsi.queryEREngine.apache.calcite.sql.SqlLateralOperator;
...
import org.imsi.queryEREngine.apache.calcite.sql.SqlNullTreatmentOperator;
...
import org.imsi.queryEREngine.apache.calcite.sql.SqlOverOperator;
import org.imsi.queryEREngine.apache.calcite.sql.SqlPostfixOperator;
import org.imsi.queryEREngine.apache.calcite.sql.SqlPrefixOperator;
import org.imsi.queryEREngine.apache.calcite.sql.SqlProcedureCallOperator;
import org.imsi.queryEREngine.apache.calcite.sql.SqlRankFunction;
...
import org.imsi.queryEREngine.apache.calcite.sql.SqlWithinGroupOperator;
...
import org.imsi.queryEREngine.apache.calcite.sql.util.ReflectiveSqlOperatorTable;
...
import org.imsi.queryEREngine.apache.calcite.sql2rel.AuxiliaryConverter;
...
/**
 * Implementation of {@link org.imsi.queryEREngine.apache.calcite.sql.SqlOperatorTable} containing
...
public class SqlStdOperatorTable extends ReflectiveSqlOperatorTable {
	 ...
	 *
	 * <ol>
	 * <li>name of window function ({@link org.imsi.queryEREngine.apache.calcite.sql.SqlCall})</li>
	 * <li>window name ({@link org.imsi.queryEREngine.apache.calcite.sql.SqlLiteral}) or window
