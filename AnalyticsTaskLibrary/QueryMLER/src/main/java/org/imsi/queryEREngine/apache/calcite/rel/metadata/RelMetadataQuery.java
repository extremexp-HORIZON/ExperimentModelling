 ...
 * <li>Add unit tests to {@code org.imsi.queryEREngine.apache.calcite.test.RelMetadataTest}.
...
public class RelMetadataQuery extends RelMetadataQueryBase {
	 ...
	 *
	 * @see #getColumnOrigins(org.imsi.queryEREngine.apache.calcite.rel.RelNode, int)
	 *
	 ...
	 * {@link BuiltInMetadata.ColumnUniqueness#areColumnsUnique(org.imsi.queryEREngine.apache.calcite.util.ImmutableBitSet, boolean)}
	...
	/** As {@link #getAverageColumnSizes(org.imsi.queryEREngine.apache.calcite.rel.RelNode)} but
