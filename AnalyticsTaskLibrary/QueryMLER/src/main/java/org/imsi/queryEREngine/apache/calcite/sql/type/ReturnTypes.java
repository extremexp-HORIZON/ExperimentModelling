...
import org.imsi.queryEREngine.apache.calcite.sql.ExplicitOperatorBinding;
...
public abstract class ReturnTypes {
	...
	public static final SqlReturnTypeInference BOOLEAN_NULLABLE_OPTIMIZED =
			...
			public static final SqlReturnTypeInference LEAST_RESTRICTIVE =
					 ...
					 * {@link org.imsi.queryEREngine.apache.calcite.sql.type.SqlTypeTransforms#TO_NULLABLE}
					 */
					...
					public static final SqlReturnTypeInference DYADIC_STRING_SUM_PRECISION =
							 ...
							 * {@link org.imsi.queryEREngine.apache.calcite.sql.type.SqlTypeTransforms#TO_NULLABLE},
							 * {@link org.imsi.queryEREngine.apache.calcite.sql.type.SqlTypeTransforms#TO_VARYING}.
							 */
							 ...
							 * as a {@link org.imsi.queryEREngine.apache.calcite.sql.validate.SqlValidatorNamespace}, and
