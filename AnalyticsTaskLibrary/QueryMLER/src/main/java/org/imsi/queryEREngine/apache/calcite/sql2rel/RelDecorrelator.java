...
import org.imsi.queryEREngine.apache.calcite.rel.rules.FilterCorrelateRule;
...
import org.imsi.queryEREngine.apache.calcite.sql.fun.SqlSingleValueAggFunction;
...
public class RelDecorrelator implements ReflectiveVisitor {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rel.core.Correlate} instances removed
	 */
	public static RelNode decorrelateQuery(RelNode rootRel,
			RelBuilder relBuilder) {
	 ...
	 * and if found, throws a {@link org.imsi.queryEREngine.apache.calcite.util.Util.FoundOne}. */
	...
	/** Builds a {@link org.imsi.queryEREngine.apache.calcite.sql2rel.RelDecorrelator.CorelMap}. */
