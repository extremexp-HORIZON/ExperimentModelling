...
import org.imsi.queryEREngine.apache.calcite.sql.validate.CyclicDefinitionException;
...
public interface CalcitePrepare {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.jdbc.CalcitePrepare.ParseResult#kind} field. */
	...
	class Dummy {
		...
		private static SparkHandler createHandler() {
			try {
				final Class<?> clazz =
						Class.forName("org.imsi.queryEREngine.apache.calcite.adapter.spark.SparkHandlerImpl");
