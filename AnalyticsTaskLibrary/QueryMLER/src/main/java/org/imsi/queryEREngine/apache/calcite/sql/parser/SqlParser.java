 ...
 */
package org.imsi.queryEREngine.apache.calcite.sql.parser;
...
import org.imsi.queryEREngine.apache.calcite.config.Lex;
...
import org.imsi.queryEREngine.apache.calcite.sql.validate.SqlDelegatingConformance;
import org.imsi.queryEREngine.apache.calcite.util.SourceStringReader;
import org.imsi.queryEREngine.imsi.calcite.sql.parser.impl.SqlParserImpl;
...
public class SqlParser {
	 ...
	 *
	 * <p>Unlike
	 * {@link #create(java.lang.String, org.imsi.queryEREngine.apache.calcite.sql.parser.SqlParser.Config)},
	 ...
	 *
	 * @return A {@link org.imsi.queryEREngine.apache.calcite.sql.SqlSelect} for a regular <code>
	 * SELECT</code> statement; a {@link org.imsi.queryEREngine.apache.calcite.sql.SqlBinaryOperator}
