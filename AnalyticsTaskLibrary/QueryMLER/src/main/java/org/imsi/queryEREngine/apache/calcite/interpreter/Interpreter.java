...
import org.imsi.queryEREngine.apache.calcite.rel.rules.CalcSplitRule;
...
import org.imsi.queryEREngine.apache.calcite.util.ReflectiveVisitDispatcher;
...
implements AutoCloseable {
	...
	/**
	 * Walks over a tree of {@link org.imsi.queryEREngine.apache.calcite.rel.RelNode} and, for each,
	 * creates a {@link org.imsi.queryEREngine.apache.calcite.interpreter.Node} that can be
