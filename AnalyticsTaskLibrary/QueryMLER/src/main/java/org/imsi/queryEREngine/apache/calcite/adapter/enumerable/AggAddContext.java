 ...
 * {@link org.imsi.queryEREngine.apache.calcite.adapter.enumerable.AggImplementor#implementAdd(AggContext, AggAddContext)}.
 *
...
public interface AggAddContext extends AggResultContext {
	/**
	 * Returns {@link org.imsi.queryEREngine.apache.calcite.rex.RexNode} representation of arguments.
	 * This can be useful for manual translation of required arguments with
	 * different {@link NullPolicy}.
	 * @return {@link org.imsi.queryEREngine.apache.calcite.rex.RexNode} representation of arguments
	 */
	List<RexNode> rexArguments();

	/**
	 * Returns {@link org.imsi.queryEREngine.apache.calcite.rex.RexNode} representation of the
	 * filter, or null.
	 */
	...
	/**
	 * Returns a
	 * {@link org.imsi.queryEREngine.apache.calcite.adapter.enumerable.RexToLixTranslator}
