...
import org.imsi.queryEREngine.apache.calcite.rel.type.StructKind;
...
public interface SqlValidatorScope {
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.sql.validate.SelectScope}) which can be the
	 * context for name-resolution. In scopes such as
	 * {@link org.imsi.queryEREngine.apache.calcite.sql.validate.IdentifierNamespace}, it throws
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.sql.validate.SqlValidatorScope.Resolved}. */
