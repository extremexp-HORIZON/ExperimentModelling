...
import org.imsi.queryEREngine.apache.calcite.runtime.GeoFunctions;
import org.imsi.queryEREngine.apache.calcite.runtime.Unit;
...
import org.imsi.queryEREngine.apache.calcite.sql.type.JavaToSqlTypeConversionRules;
...
implements JavaTypeFactory {
	 ...
	 *
	 * <p>Takes into account {@link org.imsi.queryEREngine.apache.calcite.adapter.java.Array}
	 * annotations if present.
	 */
	private Type fieldType(Field field) {
		final Class<?> klass = field.getType();
		final org.imsi.queryEREngine.apache.calcite.adapter.java.Array array =
				field.getAnnotation(org.imsi.queryEREngine.apache.calcite.adapter.java.Array.class);
		if (array != null) {
			return new Types.ArrayType(array.component(), array.componentIsNullable(),
					array.maximumCardinality());
		}
		final org.imsi.queryEREngine.apache.calcite.adapter.java.Map map =
				field.getAnnotation(org.imsi.queryEREngine.apache.calcite.adapter.java.Map.class);
		if (map != null) {
