...
import org.imsi.queryEREngine.apache.calcite.sql.type.ArraySqlType;
import org.imsi.queryEREngine.apache.calcite.sql.type.MapSqlType;
...
public class RexBuilder {
	...
	/** Creates a list of {@link org.imsi.queryEREngine.apache.calcite.rex.RexInputRef} expressions,
	 ...
	 * {@link #makeCall(org.imsi.queryEREngine.apache.calcite.rel.type.RelDataType, org.imsi.queryEREngine.apache.calcite.sql.SqlOperator, java.util.List)}
	 * is preferred.</p>
	 */
	public RexNode makeCall(
			SqlOperator op,
	 ...
	 * {@link org.imsi.queryEREngine.apache.calcite.rex.RexLiteral#valueMatchesType}. */
