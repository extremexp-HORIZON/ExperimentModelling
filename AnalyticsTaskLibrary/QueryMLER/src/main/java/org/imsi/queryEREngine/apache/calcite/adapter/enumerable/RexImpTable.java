...
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.CHR;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.COSH;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.DAYNAME;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.DIFFERENCE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.EXISTS_NODE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.EXTRACT_VALUE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.EXTRACT_XML;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.FROM_BASE64;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.JSON_DEPTH;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.JSON_KEYS;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.JSON_LENGTH;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.JSON_PRETTY;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.JSON_REMOVE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.JSON_STORAGE_SIZE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.JSON_TYPE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.LEFT;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.MD5;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.MONTHNAME;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.REGEXP_REPLACE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.REPEAT;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.REVERSE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.RIGHT;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.SHA1;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.SOUNDEX;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.SPACE;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.TANH;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.TO_BASE64;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.TRANSLATE3;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlLibraryOperators.XML_TRANSFORM;
import static org.imsi.queryEREngine.apache.calcite.sql.fun.SqlStdOperatorTable.*;
...
import org.imsi.queryEREngine.apache.calcite.schema.ImplementableAggFunction;
import org.imsi.queryEREngine.apache.calcite.schema.ImplementableFunction;
import org.imsi.queryEREngine.apache.calcite.schema.impl.AggregateFunctionImpl;
import org.imsi.queryEREngine.apache.calcite.sql.SqlAggFunction;
import org.imsi.queryEREngine.apache.calcite.sql.SqlBinaryOperator;
...
import org.imsi.queryEREngine.apache.calcite.sql.fun.SqlJsonArrayAggAggFunction;
import org.imsi.queryEREngine.apache.calcite.sql.fun.SqlJsonObjectAggAggFunction;
import org.imsi.queryEREngine.apache.calcite.sql.fun.SqlStdOperatorTable;
import org.imsi.queryEREngine.apache.calcite.sql.fun.SqlTrimFunction;
...
import org.imsi.queryEREngine.apache.calcite.sql.validate.SqlUserDefinedAggFunction;
import org.imsi.queryEREngine.apache.calcite.sql.validate.SqlUserDefinedFunction;
...
public class RexImpTable {
	...
	public CallImplementor get(final SqlOperator operator) {
		if (operator instanceof SqlUserDefinedFunction) {
			org.imsi.queryEREngine.apache.calcite.schema.Function udf =
